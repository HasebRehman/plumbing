...
export default function QuickQuoteModal({
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/80 backdrop-blur-md overflow-hidden pointer-events-auto">
          ...
          <motion.div
            ...
            className="relative w-full max-w-xl max-h-[90vh] overflow-y-auto no-scrollbar rounded-3xl bg-[#0D1017] border border-white/15 p-6 sm:p-8 shadow-2xl z-10"
          >
            {/* Close Button */}
            <button
              onClick={onClose}
              className="absolute top-5 right-5 p-2.5 rounded-full bg-white/5 hover:bg-[#FF6B00] text-slate-400 hover:text-white transition-colors duration-200"
            ...
            {submitted ? (
              <div className="py-12 text-center flex flex-col items-center justify-center">
                <div className="p-4 rounded-full bg-emerald-500/20 text-emerald-400 mb-4 border border-emerald-500/30">
              ...
              <div>
                ...
                <div className="flex items-center gap-3.5 mb-6">
                  <div className="p-3 rounded-2xl bg-[#FF6B00]/20 text-[#FF6B00] flex-shrink-0">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="relative" ref={dropdownRef}>
                    ...
                    <button
                      ...
                      className={`w-full flex items-center justify-between rounded-xl bg-[#141923] border px-4 py-3.5 text-sm text-white transition-all duration-300 ${
                        isDropdownOpen
                          ? "border-[#FF6B00] ring-2 ring-[#FF6B00]/30 shadow-glow"
                          : "border-white/15 hover:border-[#FF6B00]/60"
                      }`}
                    >
                    ...
                    <AnimatePresence>
                      {isDropdownOpen && (
                        <motion.div
                          ...
                          className="absolute left-0 right-0 z-50 rounded-2xl bg-[#161C27] border border-[#FF6B00]/40 p-2 shadow-2xl backdrop-blur-2xl max-h-60 overflow-y-auto no-scrollbar space-y-1"
                        >
                            ...
                            return (
                              <button
                                ...
                                className={`w-full flex items-center justify-between px-3.5 py-3 rounded-xl text-xs sm:text-sm font-semibold transition-all ${
                                  isSelected
                                    ? "bg-[#FF6B00] text-white shadow-glow"
                                    : "text-slate-200 hover:bg-[#FF6B00]/20 hover:text-white"
                                }`}
                              >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-1">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full rounded-xl bg-white/5 border border-white/15 px-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-[#FF6B00] transition-all"
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-bold text-slate-300 uppercase tracking-wider mb-1.5">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full rounded-xl bg-white/5 border border-white/15 px-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-[#FF6B00] transition-all resize-none"
                    />
                  </div>
